        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Props & Defaults', link: '/guide/props-and-defaults' },
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              // hidden for now — examples over specs: { text: 'Virtual Scroller: Specs', link: '/examples/virtual-scroller-specs' },
              { text: 'Horizontal Scroller: 1M Items', link: '/examples/horizontal-scroller' },
              { text: 'Scroll Stage: scenes on the scroll', link: '/examples/scroll-stage' },
              { text: 'Scroll Flight: a plane, a flock, on the scroll', link: '/examples/scroll-flight' },
              // hidden for now — examples over specs: { text: 'Horizontal Scroller: Specs', link: '/examples/horizontal-scroller-specs' },
