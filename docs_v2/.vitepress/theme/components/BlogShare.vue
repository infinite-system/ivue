    ...
    <div class="blog-share__buttons">
      ...
      >
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path fill="currentColor" :d="target.icon" />
        </svg>
      </a>
      <button
      ...
      >
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path
            fill="currentColor"
            d="M18 16.1c-.76 0-1.44.3-1.96.77L8.9 12.7c.05-.23.1-.46.1-.7s-.05-.47-.1-.7l7.05-4.11A2.99 2.99 0 0 0 21 5a3 3 0 1 0-6 0c0 .24.04.47.1.7L8.04 9.81A2.99 2.99 0 0 0 3 12a3 3 0 0 0 5.04 2.19l7.12 4.16c-.06.21-.1.44-.1.67a2.94 2.94 0 1 0 2.94-2.92Z"
          />
        </svg>
      ...
      >
        ...
        <svg v-else viewBox="0 0 24 24" aria-hidden="true">
          <path
            fill="currentColor"
            d="M9.55 17.05 4.9 12.4l1.4-1.4 3.25 3.24 8.15-8.15 1.4 1.42-9.55 9.54Z"
          />
        </svg>
