---
venue: TokenMade YouTube podcast
purpose: pitch-email
lang: en
...
Subject: Guest application — replay one agent task through its mechanical referee
...
The viewer gets a method: name the failure, make it unrepresentable where possible, and gate the rest.

https://ivue.dev/blog/the-zeros-didnt-move

If that is not the kind of workflow you want, no reply is needed.
