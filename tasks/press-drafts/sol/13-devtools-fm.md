...
Subject: Guest application — the 1.1 kB layer under a 108,000-line IDE
...
ivue is a 1.1 kB class layer over Vue's reactivity. An AI-agent fleet used it to build Invar, a terminal IDE with 108,000 lines of editor source.
