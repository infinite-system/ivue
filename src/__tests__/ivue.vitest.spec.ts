...
import { ivue, getAllClassDescriptors, getAllClassProperties } from "../index";
...
class Item extends Bit {
  _width = ref(5) as unknown as string | number;
  unit = ref("px") as unknown as string;
  get width(): string {
    return String(this._width) + this.unit;
  }
  set width(value: string | number) {
    this._width = value;
  }
  _height = ref(5) as unknown as string | number;
  get height(): string {
    return String(this._height) + this.unit;
  }
