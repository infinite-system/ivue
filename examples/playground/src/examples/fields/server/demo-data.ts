...
export const seedContacts: ContactRow[] = [
  ...
  },
  {
    ...
    company: 'NASA',
    kind: 'person',
    description: 'Calculated orbital trajectories'
  },
  {
    id: '5',
    ...
    kind: 'person',
    description: 'Led Apollo flight software'
  },
  {
    id: '6',
    name: 'Dennis Ritchie',
    ...
    company: 'Bell Labs',
    kind: 'person',
    description: 'Created C and co-created Unix'
  },
  {
    id: '7',
    name: 'Barbara Liskov',
    ...
    company: 'MIT',
    kind: 'person',
    description: 'Substitution principle'
  },
  {
    id: '8',
    name: 'Linus Torvalds',
  ...
  },
  {
    ...
    company: 'Vue.js',
    kind: 'person',
    description: 'Created Vue'
  },
  {
    id: '11',
    name: 'Analytical Engines',
    email: 'info@analytical.engine',
    role: '',
    company: '',
    kind: 'company',
    description: 'Difference engines and more'
  },
  {
    id: '12',
    name: 'Bell Labs',
    email: 'info@bell-labs.com',
    role: '',
    company: '',
    kind: 'company',
    description: 'Where Unix was born'
  },
  {
    id: '13',
    name: 'Bletchley Park',
    email: 'info@bletchley.uk',
    role: '',
    company: '',
    kind: 'company',
    description: 'Wartime codebreaking'
  },
  {
    id: '14',
    name: 'NASA',
