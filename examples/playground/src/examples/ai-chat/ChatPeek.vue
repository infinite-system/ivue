...
<template>
  <Teleport to="body">
    <div
      class="ai-chat ac-portal"
      :class="model.portalClass"
    ...
    >
      <Transition name="ac-peek">
        <aside
          ...
          class="ac-peek"
          :style="model.style"
          @pointerenter="model.onCardEnter()"
          @pointerleave="model.onCardLeave()"
        >
          <div class="ac-index-search ac-peek-search">
            ...
            <input
              ...
              @focus="model.onSearchFocus()"
              @blur="model.onSearchBlur()"
              @keydown="model.onSearchKeydown($event)"
            />
