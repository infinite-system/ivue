...
const model = new ((props.kit?.namespace.Class as typeof Sidebar.Class | undefined) ?? Sidebar.Class)(props);
</script>

<template>
  <aside class="ac-side" :class="model.sideClass">
    <div v-if="model.isOpen" class="ac-side-panel" :style="model.panelStyle">
      <div class="ac-side-grip" title="Drag to resize" @pointerdown="model.onResizeStart($event)"></div>
