...
class $PartThinking {
  constructor(public props: Part.Props<SessionLog.PartThinking>) {}

  get part(): SessionLog.PartThinking {
...
export namespace PartThinking {
  export const $Class = $PartThinking;
