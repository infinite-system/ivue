...
import CallGenericView from './calls/CallGeneric.vue';
import { CallBash } from './calls/CallBash';
import CallBashView from './calls/CallBash.vue';
import { CallEdit } from './calls/CallEdit';
import CallEditView from './calls/CallEdit.vue';
import { CallRead } from './calls/CallRead';
import CallReadView from './calls/CallRead.vue';
import { CallWrite } from './calls/CallWrite';
import CallWriteView from './calls/CallWrite.vue';
import { CallAgent } from './calls/CallAgent';
import CallAgentView from './calls/CallAgent.vue';
import { CallSkill } from './calls/CallSkill';
import CallSkillView from './calls/CallSkill.vue';
import { CallWebFetch } from './calls/CallWebFetch';
import CallWebFetchView from './calls/CallWebFetch.vue';
import { CallArtifact } from './calls/CallArtifact';
import CallArtifactView from './calls/CallArtifact.vue';
import { CallTask } from './calls/CallTask';
import CallTaskView from './calls/CallTask.vue';
import { CallMcp } from './calls/CallMcp';
import CallMcpView from './calls/CallMcp.vue';
