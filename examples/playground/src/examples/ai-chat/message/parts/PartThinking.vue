...
import { PartThinking } from './PartThinking';

const props = defineProps<Part.Props<SessionLog.PartThinking>>();

const model = new (
  (props.kit?.namespace.Class as typeof PartThinking.Class | undefined) ?? PartThinking.Class
)(props);
</script>
