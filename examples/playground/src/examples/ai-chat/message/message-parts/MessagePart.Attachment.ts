...
class $MessagePartAttachment {
  constructor(public props: MessagePart.Props<SessionLog.AttachmentPart>) {}
...
export namespace MessagePartAttachment {
  export const $Class = $MessagePartAttachment;
