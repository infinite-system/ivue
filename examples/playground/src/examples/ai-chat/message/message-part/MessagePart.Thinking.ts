...
class $MessagePartThinking {
  constructor(public props: MessagePart.Props<SessionLog.ThinkingPart>) {}
...
export namespace MessagePartThinking {
  export const $Class = $MessagePartThinking;
