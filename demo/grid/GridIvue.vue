...
document.title = 'Grid · ivue model';
</script>
  ...
  <section class="space-y-6">
    <header class="space-y-2">
      ...
      >
        ...
        Arm B · ivue class $Cell (ref-getter + plain getters + 1 computed)
      </div>
      ...
      <p class="max-w-3xl text-sm leading-relaxed text-slate-400">
        ...
        <code class="text-indigo-300">numericValue</code> is a
        <code class="text-indigo-300">computed()</code>. Refs/computeds
        materialize lazily — unrendered cells allocate nothing.
      </p>
    </header>
